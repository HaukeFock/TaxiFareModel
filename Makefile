...
PROJECT_ID=lewagon-hf-ds-bootcamp-566 
...
LOCAL_PATH="/home/hauke/code/HaukeFock/TaxiFareModel/raw_data/train_1k.csv" # Replace with your local path to the `train_1k.csv` and make sure to put it between quotes
